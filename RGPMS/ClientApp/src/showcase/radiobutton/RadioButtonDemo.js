                ...
                <div className="content-section implementation">
                    <div className="ui-g" style={{width:'250px',marginBottom:'10px'}}>
                        <div className="ui-g-12">
                            <RadioButton inputId="rb1" name="city" value="New York" onChange={(e) =>this.onChange(e) } checked={this.state.city === 'New York'} />
                            <label htmlFor="rb1">New York</label>
                        </div>
                        <div className="ui-g-12">
                            <RadioButton inputId="rb2" name="city" value="San Francisco" onChange={(e) =>this.onChange(e) } checked={this.state.city === 'San Francisco'} />
                            <label htmlFor="rb2">San Francisco</label>
                        </div>
                        <div className="ui-g-12">
                            <RadioButton inputId="rb3" name="city" value="Los Angeles" onChange={(e) =>this.onChange(e) } checked={this.state.city === 'Los Angeles'} />
